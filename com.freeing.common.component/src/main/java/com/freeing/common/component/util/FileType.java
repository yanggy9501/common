...
public enum FileType {
    ...
    public static FileType match(String value) {
        final String fileHeader = value.toLowerCase(Locale.ENGLISH);
        for (FileType fileType : FileType.values()) {
            if (fileHeader.startsWith(fileType.value.toLowerCase(Locale.ENGLISH))) {
                return fileType;
            }
        }
